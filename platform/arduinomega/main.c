//Wallplotter code based on Fumik, uses 4 Steppers instead of two but the code has been mostly retained as two axis were cloned by hardware,
//the X axis was mapped to the A axis of the cnc shield and the polarisation of the stepper motor on the A axis was inverted by wiring
// the Y axis was mapped to the Z axis of the cnc shield and the polarisation of the stepper motor on the Z axis was inverted by wiring
...
int counterXStepper = 0;
int counterYStepper = 0;
int counterZStepper = 0;
int counterAStepper = 0;
...
#define dirPin_a  5;
#define stepPin_a  2
//const int dirPin_p = 7; // short wired with pin 6   
//const int stepPin_p = 4;  // short wired with pin 3
const int enPin = 8;
...
void setup() {
  ...
  Serial.begin(115200); //setup serial for UART connection
